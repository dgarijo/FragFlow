 ...
 */
public class Test18ValidateFoundFragments3 {    
    public static int testNumber = 18;
        ...
        try{
            ...
            while(fragments.hasNext()){
                ...
                if(f.isMultiStepFragment()){//to ensure it is a meaningful fragment
                    String currentQuery = qr.createQueryFromFragment(f, "http://www.opmw.org/export/resource/WorkflowTemplate/SIMILARWORDS");
                    ...
                    if(f.getStructureID().equals("SUB_2")&&numberOfTimes!=0)return false;
                    ...
                    if(f.getStructureID().equals("SUB_6")&&numberOfTimes!=1)return false;
