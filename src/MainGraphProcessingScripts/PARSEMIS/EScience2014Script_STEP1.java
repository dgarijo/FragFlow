...
public class EScience2014Script_STEP1 {
    ...
    public static void main(String [] args) throws CollectionWriterException{
        System.out.println("\n Writing LONI datasets in Parsemis format");
        ...
        processFolder(escienceBoris, "corpus1PublicBoris.lg");
        processFolder(escienceIvo, "corpus2PrivateIvo.lg");
        processFolder(escienceMonthly, "corpus3Monthly.lg");
