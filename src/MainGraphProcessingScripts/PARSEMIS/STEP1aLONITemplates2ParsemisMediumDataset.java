 ...
 */
public class STEP1aLONITemplates2ParsemisMediumDataset {
    public static void main(String [] args) throws CollectionWriterException{
        ...
        if(f.isDirectory()){
            ...
            writer.writeReducedGraphsToFile(test.getGraphCollection(),Configuration.getPARSEMISInputPath()+ "LoniZhitEncoded.lg", null);
        }
    }
