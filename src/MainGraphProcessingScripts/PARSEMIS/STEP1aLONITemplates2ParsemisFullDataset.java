...
public class STEP1aLONITemplates2ParsemisFullDataset {
    public static void main(String [] args) throws CollectionWriterException{
        ...
        if(f.isDirectory()){
            ...
            writer.writeReducedGraphsToFile(test.getGraphCollection(),Configuration.getPARSEMISInputPath()+ "LoniReducedDatasetEncoded.lg", null);
        }
    }
