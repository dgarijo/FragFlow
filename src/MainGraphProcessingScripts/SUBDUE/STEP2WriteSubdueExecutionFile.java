 ...
 */
public class STEP2WriteSubdueExecutionFile {

    /**
     * Default creator
     */
    public STEP2WriteSubdueExecutionFile() {
    }
...
//                    System.out.println("cmd /C "+toExecuteEval2);
            ...
            out.close();
            fstream.close();
            //fragment of code designed to execute the script. However it doesn't work as specified.
