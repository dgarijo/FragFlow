 ...
 */
package MainGraphProcessingScripts.SUBDUE.WINGSWorkflow;
 ...
 */
public class ReadAndFilterLoniFolder {
...
//            System.out.println(loniDatasetFolder);
            ...
            if(f.isDirectory()){
                ...
                writer.writeReducedGraphsToFile(filteredC,outputFile, null);
                System.out.println("Final dataset size: "+filteredC.getNumberOfSubGraphs());
            }else{
