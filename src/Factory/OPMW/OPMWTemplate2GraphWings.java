...
import DataStructures.GraphNode.OPMW.GraphNodeTemplatesOPMWWings;
 ...
 * Specialization for Wings Workflows.
 * @author Daniel Garijo
 */
public class OPMWTemplate2GraphWings extends GraphCollectionCreator{

    /**
     * Creation method
     * @param repositoryURI 
     */
    public OPMWTemplate2GraphWings(String repositoryURI) {
        super(repositoryURI);
    }
    ...
    public void transformToGraph(String URI) {
        ...
        while(nodesAndTypes.hasNext()){
            ...
            if(nodes.containsKey(currNode.getURI())){
                ...
                nodes.put(currNode.getURI(), new GraphNodeTemplatesOPMWWings(currNode.getURI(), type.getURI(), countNodes));
                countNodes++;
