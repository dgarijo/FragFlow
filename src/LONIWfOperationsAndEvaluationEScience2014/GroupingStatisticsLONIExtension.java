 ...
 */
public class GroupingStatisticsLONIExtension {
    ...
    public GroupingStatisticsLONIExtension(String folder) {
...
//                        System.out.print("current max: "+groupingSize);
    ...
    public static String getStatsFromFolder(String folderPath){
        GroupingStatisticsLONIExtension g = new GroupingStatisticsLONIExtension(folderPath);
    ...
    public static String getStatsFilteredFolder(String folderPath){
        ...
        System.out.println("Number of filtered workflows: "+filteredCollection.getGraphs().size());
        return g.printStats();
    }
    ...
    public static void main(String[] args){
        ...
        stats = "All Sam's dataset\n";
        stats += getStatsFilteredFolder(escienceSam);
