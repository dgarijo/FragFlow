...
public class GraphNodeTemplatesOPMWWings extends GraphNode{
    ...
    public void setType(String type) {
        ...
        if(type.contains(OPMWTemplate.WINGS_ABS_COMP_CATALOG_URI)||type.contains(OPMWTemplate.WINGS_DATA_CATALOG_URI)){
            this.type = type;            
        }else 
            if((type.contains("DataVariable")||type.contains("Parameter")||type.contains("Process"))&&(!(this.type.contains(OPMWTemplate.WINGS_ABS_COMP_CATALOG_URI))&&(!this.type.contains(OPMWTemplate.WINGS_DATA_CATALOG_URI)))){
                this.type = type;
        }
    }
